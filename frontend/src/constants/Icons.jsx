...
// All icons combined from manager, order, and team components
export const Icons = {
  // Manager icons
  ...
  exclamation: (<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>),
  ...
  star: (<svg width="14" height="14" viewBox="0 0 24 24" fill="#007D00" stroke="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>),
  ...
  filePlaceholder: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#D8ECD0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>),
  chartBar: (<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/><line x1="2" y1="20" x2="22" y2="20"/></svg>),
  ...
  imagePlaceholder: (
    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#D8ECD0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
// Export Icon as an alias for backwards compatibility
